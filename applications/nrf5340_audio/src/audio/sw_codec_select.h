...
#define ENC_MAX_FRAME_SIZE                                                                         \
	MAX(MAX(LC3_ENC_MONO_FRAME_SIZE, SBC_ENC_MAX_FRAME_SIZE), OPUS_FRAME_SIZE)
#define PCM_NUM_BYTES_MONO                                                                         \
	MAX(MAX(LC3_PCM_NUM_BYTES_MONO, SBC_PCM_NUM_BYTES_MONO), OPUS_PCM_NUM_BYTES_MONO)
