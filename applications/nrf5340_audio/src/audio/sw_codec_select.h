...
#define OPUS_FRAME_SIZE (OPUS_SAMPLE_RATE * OPUS_MAX_FRAME_SIZE_MS / 1000)
...
#define OPUS_SAMPLE_RATE 0
#define OPUS_BITRATE 0
#define OPUS_MAX_FRAME_SIZE 0
#define OPUS_MAX_PACKET_SIZE 0
...
#define ENC_MAX_FRAME_SIZE MAX(MAX(LC3_ENC_MONO_FRAME_SIZE, SBC_ENC_MAX_FRAME_SIZE),OPUS_FRAME_SIZE)
#define PCM_NUM_BYTES_MONO MAX(MAX(LC3_PCM_NUM_BYTES_MONO, SBC_PCM_NUM_BYTES_MONO), 2*OPUS_FRAME_SIZE)
